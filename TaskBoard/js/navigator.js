require.define('/js/navigator.js', function (require, module, exports) {
    "use strict";

    var appView = require('Windows/UI/ViewManagement/ApplicationView');
    var nav = require('WinJS/Navigation');
    var klass = require('WinJS/Class');

    exports.PageControlNavigator = klass.define(
        function(element, options) {
            ...
            _navigated: function(args) {
                ...
                var navModule = require(args.detail.location + '.js');

                this._lastNavigationPromise = WinJS.Promise.timeout().then(function() {
                    return WinJS.UI.Pages.render(args.detail.location + '.html', newElement, args.detail.state, parented);
